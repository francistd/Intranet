...
<div class="modal fade" id="EditarAdmVacaci" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						...
						<div class="row">
							<div class="col">
								...
								<div class="col-sm-10 mx-auto">
									...
									<input type="date" id="AdmEditarInicial" class="form-control form-control-sm" placeholder="Movil Personal">
								</div>
								<div class="col-sm-10 mx-auto">
									<label><strong>Fecha Final:</strong></label>
									<input type="date" id="AdmEditarFinal" class="form-control form-control-sm" placeholder="Extensión">
								</div>
								<div class="col-sm-10 mx-auto">
									<label><strong>Total Dias:</strong></label>
									<input type="text" id="AdmdiasEditar" disabled class="form-control form-control-sm" placeholder="Total dias">
								</div>
							</div>
