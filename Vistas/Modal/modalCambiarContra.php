...
<div class="modal fade" id="EditarContraseña" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-pencil-alt"></i> Cambiar Contraseña</h5>
						...
						<div class="row">
							<div class="col">
								<div class="col-sm-10 mx-auto">
									...
									<input type="text" disabled class="form-control form-control-sm" placeholder="Nombre">
								</div>

								<div class="col-sm-10 mx-auto">
									<label><strong>Nueva Contraseña:</strong></label>
									<input type="password" class="form-control form-control-sm" placeholder="Nueva Contraseña">
								</div>
