...
<body style="background-color: #000046">
		...
		<div class="row">
			<div class="col-md-12 rounded alert-secondary " style="background-color: #ECF0F1; margin-bottom: 30px" >
				...
				<div class="col-md-12" style="margin-bottom: 4px">
					<div class="text-center">
						<button class=" agregaEmp btn btn-success text-right" data-toggle="modal" data-target="#AgregaCarta"><i class="fas fa-plus"></i> </button>
					</div>
				</div>
				<!-- Prueba -->
					...
					<table class="table table-sm table-hover">
						...
						<tbody>
							<tr>
								...
								<td>
									<button class="Edita btn btn-primary btn-sm" data-toggle="modal" data-target="#EditarCarta" style="margin-bottom: 4px"><i class="fas fa-external-link-alt"></i></button>
	...
	<?php include "Modal/modalCartas.php" ?>
<!-- Pie -->
